  ...
  <body>
    <div class="login-container">
      <div class="login-card">
        ...
        <div class="login-body"> <?php if(isset($_GET['pending'])): ?> <div class="alert alert-info alert-dismissible fade show" role="alert"> Your account has been created and is pending admin approval. <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
          </div> <?php endif; ?> <?php if($error): ?> <div class="alert alert-danger alert-dismissible fade show" role="alert"> <?php echo $error; ?> <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
          </div> <?php endif; ?> <form method="POST" action="">
            <div class="mb-3">
          ...
          <div class="register-link">
            ...
            <small class="text-muted d-block mt-2"> Admin & Judge accounts are created by system administrator </small>
          </div>

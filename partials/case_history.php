...
<div class="card">
    ...
    <div class="card-body">
        <?php if(mysqli_num_rows($closedCases) > 0): ?>
            <table class="table table-hover">
                ...
                <tbody>
                    <?php while($c = mysqli_fetch_assoc($closedCases)): ?>
                        <tr>
                            ...
                            <td>
                                <a href="view_case.php?case_id=<?= urlencode($c['case_id']) ?>" class="btn btn-sm btn-info">View Case</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>

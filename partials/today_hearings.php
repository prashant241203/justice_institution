...
$todayHearings = mysqli_query($conn, "
    ...
    WHERE c.judge_id = '$judgeId' AND h.hearing_date = '$today'
...
<div class="card">
    ...
    <div class="card-body">
        <?php if(mysqli_num_rows($todayHearings) > 0): ?>
            <table class="table table-hover">
                ...
                <tbody>
                    <?php while($h = mysqli_fetch_assoc($todayHearings)): ?>
                        <tr>
                            ...
                            <td>
                                <a href="view_case.php?case_id=<?= urlencode($h['case_id']) ?>" class="btn btn-sm btn-info">View Case</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>

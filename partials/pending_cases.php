...
?> <?php if(count($pendingCasesArray) > 0): ?> <div class="card">
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-hover case-list">
        ...
        <tbody> <?php foreach($pendingCasesArray as $case): ?> <tr>
            ...
            <td> <?php if ($case['hearing_count'] > 0): ?> <a href="add_judgement.php?case_id=
								<?= urlencode($case['case_id']) ?>" class="btn btn-sm btn-success">
                <i class="bi bi-gavel"></i> Judge Now </a> <?php else: ?> <span class="text-muted">No hearings yet</span> <?php endif; ?> </td>
          </tr> <?php endforeach; ?> </tbody>
      </table>
    </div>
  </div>
</div> <?php else: ?> <p>No pending judgements.</p> <?php endif; ?>
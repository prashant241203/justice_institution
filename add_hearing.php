        ...
        <div class="col-md-7">
          <div class="card shadow">
            ...
            <form method="POST" class="card-body">
              <div class="mb-3"><label class="form-label">Case</label><input class="form-control" value="
<?= htmlspecialchars($case['case_id']) ?> - 
<?= htmlspecialchars($case['title']) ?>" disabled><small class="text-muted">Status: <?= $case['status'] ?></small></div>
              <div class="mb-3"><label class="form-label">Hearing Date</label><input type="date" name="hearing_date" class="form-control" required></div>
              <div class="mb-3"><label class="form-label">Court Name / Number</label><input type="text" name="court_name" class="form-control" required></div>
              <div class="d-flex justify-content-between"><a href="index.php" class="btn btn-secondary">Back</a><button class="btn btn-primary" name="schedule_hearing"> Schedule Hearing </button></div>
            </form>
          </div>
        </div>
      </div>

...
<body>
    <div class="access-card">
        ...
        <div class="access-body">
            ...
            <div class="role-info">
                <h6><i class="bi bi-person-badge"></i> Current Session Information</h6>
                <div class="row mt-3">
                    <div class="col-md-6">
                        <small class="text-muted">User Name</small>
                        <div class="fw-bold">
                            <?php echo htmlspecialchars($_SESSION['user_name'] ?? 'Not logged in'); ?>
                        </div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="alert alert-warning">
                ...
                <strong>Note:</strong> This page requires specific user privileges. 

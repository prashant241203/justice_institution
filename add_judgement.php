  ...
  <body class="bg-light">
    <div class="container mt-5">
      <div class="row justify-content-center">
        <div class="col-md-8"> <?php if(isset($error)): ?><div class="alert alert-danger"> <?= htmlspecialchars($error) ?></div> <?php endif; ?><div class="card shadow">
            <div class="card-header bg-success text-white">
              <h5 class="mb-0">Judge – Deliver Judgement</h5>
            </div>
            <form method="POST" class="card-body">
              <div class="mb-3"><label class="form-label">Case</label><select name="case_id" class="form-control" required id="caseSelect">
                  <option value="">Select Case</option> <?php
...
?>
              ...
              <div class="mb-3"><label>Judgement Date</label><input type="date" name="judgement_date" class="form-control" required value="
<?= date('Y-m-d') ?>"></div>
              <div class="mb-3"><label>Outcome</label><select name="outcome" class="form-control" required>
              ...
              <div class="mb-3"><label>Judgement Summary</label><textarea name="summary" class="form-control" rows="5" required></textarea></div>
              <div class="d-flex justify-content-between"><a href="index.php" class="btn btn-secondary">← Back</a><button name="add_judgement" class="btn btn-success">✓ Deliver Judgement</button></div>
            </form>
          </div>
        </div>
      </div>

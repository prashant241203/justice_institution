...
<html lang="en">
  <head>
    ...
    <title>Lawyer Registration - Justice & Institutions</title>
    ...
    <div class="register-container">
      <div class="register-card">
        <div class="register-header">
          ...
          <div class="logo-subtext">Lawyer Account Registration</div>
        </div>
        <div class="register-body"> <?php if($message): ?> <div class="alert alert-danger alert-dismissible fade show"> <?php echo $message; ?> <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
            ...
            <div class="d-grid gap-2">
              <button type="submit" name="register" class="btn btn-primary btn-lg">
                <i class="bi bi-person-plus"></i> Register as Lawyer </button>
            </div>
          </form>
          <div class="text-center mt-3">
            <small> Already have an account? <a href="login.php">Login here</a>
            </small>
          </div>
          <div class="text-center mt-3">
